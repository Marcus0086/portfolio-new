      ...
      <div className="border-b border-line">
        {timeline.map((entry) => (
          <Reveal key={entry.span}>
            <div className="grid grid-cols-1 items-baseline gap-2.5 border-t border-line px-6 py-8 transition-colors duration-300 hover:bg-fg/3 md:grid-cols-[220px_1fr_1.4fr] md:gap-6 md:px-12">
