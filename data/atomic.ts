...
export const docsSections: DocsSection[] = [
  ...
  { id: "cells-codecs", title: "Define a value", summary: "A cell gives a stored value a name, a TypeScript type, a default, and rules for checking old or broken data.", labId: "application-demo" },
  { id: "request-flow", title: "Move data from server to browser", summary: "Read on the server, include safe values in the page, and start the browser with the exact same values.", labId: "application-demo" },
  { id: "adapters", title: "Choose where data lives", summary: "Cookies work on the server and in the browser. Browser storage and request memory only work on one side.", labId: "application-demo" },
